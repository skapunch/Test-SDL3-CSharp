...
public static unsafe partial class SDL
{
    ...
    [LibraryImport(nativeLibName)]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial SDLBool SDL_StretchSurface(ref SDL_Surface src, ref SDL_Rect srcrect, ref SDL_Surface dst, ref SDL_Rect dstrect, SDL_ScaleMode scaleMode); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    public static Span<IntPtr> SDL_GetTrayEntries(IntPtr menu, ref int count)
    {
        var result = SDL_GetTrayEntries(menu, count);
        return new Span<IntPtr>((void*)result, size);
    }

    [LibraryImport(nativeLibName)]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial IntPtr SDL_GetTrayEntries(IntPtr menu, ref int count); // WARN_UNKNOWN_POINTER_PARAMETER
